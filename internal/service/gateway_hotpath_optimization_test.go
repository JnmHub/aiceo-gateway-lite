...
func TestGetAvailableModels_GatewayLiteUsesPlatformPool(t *testing.T) {
	resetGatewayHotpathStatsForTest()
		...
		all: []Account{
			{
				...
				Credentials: map[string]any{
					"model_mapping": map[string]any{
						...
						"mimo-v2.5-extra": "mimo-v2.5-extra",
					},
				},
			},
		},
	...
	require.Contains(t, models, "mimo-v2.5")
	require.NotContains(t, models, "old-group-only")
