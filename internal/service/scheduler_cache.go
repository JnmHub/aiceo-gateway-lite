...
// SchedulerGroupCache is implemented by scheduler caches that can keep the
// lightweight group metadata needed by gateway-lite routing decisions.
type SchedulerGroupCache interface {
