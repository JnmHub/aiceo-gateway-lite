...
// maxWait should be derived from the control-plane concurrency policy.
...
// CalculateMaxWait returns the control-plane concurrency value without adding
// gateway-local extra capacity.
