...
const (
	...
	// GeminiCLIOAuthClientID/Secret are intentionally empty in the public standalone repo.
	// Operators can provide their own OAuth client, or set GEMINI_CLI_OAUTH_CLIENT_SECRET
	// together with a patched/packaged client ID if they control that integration.
