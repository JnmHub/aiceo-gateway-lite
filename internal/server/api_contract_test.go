		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySMTPFromName: "JnmGatewayApi",
					...
					service.SettingKeySiteName:     "JnmGatewayApi",
		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"site_name": "JnmGatewayApi",
					"site_logo": "",
					"site_subtitle": "AI Gateway API Management",
					"api_base_url": "",
					"api_key_acl_trust_forwarded_ip": false,
					"contact_info": "",
					"doc_url": "",
