export default {
  ...
  // Setup Wizard
  setup: {
    title: 'JnmGatewayApi 安装向导',
    description: '配置您的 JnmGatewayApi 实例',
    database: {
      title: '数据库配置',
  ...
  admin: {
    ...
    modelPrices: {
      ...
      editTitle: '编辑模型价格',
      resetOverride: '取消覆盖',
      resetConfirm: '确定取消 {model} 的覆盖价吗？取消后会回退到默认价格。',
      emptyTitle: '暂无模型价格',
      emptyDescription: '新增覆盖价或检查默认价格目录是否加载成功',
      model: '模型',
      provider: '供应商',
      mode: '模式',
      promptCaching: '支持缓存计费',
      imagePrice: '图片单价',
      modelRequired: '请填写模型名称',
      priceRequired: '请至少填写一个价格字段',
      loadError: '加载模型价格失败',
      saveSuccess: '模型价格已保存',
      saveError: '保存模型价格失败',
      resetSuccess: '覆盖价已取消',
    ...
    settings: {
      title: '系统设置',
      description: '管理轻量网关基础配置、管理员安全和转发设置',
      gatewayLiteDescription: '管理轻量网关基础配置、管理员安全和转发设置'
    },
