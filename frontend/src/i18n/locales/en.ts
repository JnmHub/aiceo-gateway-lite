export default {
  ...
  // Setup Wizard
  setup: {
    title: 'JnmGatewayApi Setup',
    description: 'Configure your JnmGatewayApi instance',
    database: {
  ...
  admin: {
    ...
    modelPrices: {
      title: 'Model Prices',
      description: 'Manage default model prices and local overrides',
      searchPlaceholder: 'Search model or provider...',
      allProviders: 'All Providers',
      allSources: 'All Sources',
      create: 'Add Price',
      createTitle: 'Add Model Price',
      editTitle: 'Edit Model Price',
      resetOverride: 'Reset Override',
      resetConfirm: 'Reset override for {model}? The effective price will fall back to the default catalog.',
      emptyTitle: 'No Model Prices',
      emptyDescription: 'Add an override or check whether the default pricing catalog loaded successfully',
      model: 'Model',
      provider: 'Provider',
      mode: 'Mode',
      promptCaching: 'Supports prompt caching',
      imagePrice: 'Image price',
      modelRequired: 'Model is required',
      priceRequired: 'At least one price field is required',
      loadError: 'Failed to load model prices',
      saveSuccess: 'Model price saved',
      saveError: 'Failed to save model price',
      resetSuccess: 'Override reset',
      resetError: 'Failed to reset override',
      columns: {
        model: 'Model',
        provider: 'Provider',
        prices: 'Token Prices (USD / 1M)',
        image: 'Image Price',
        source: 'Source',
        actions: 'Actions'
      },
      source: {
        ...
        override: 'Override',
        staticFallback: 'Built-in Fallback'
      }
    },
    ...
    settings: {
      ...
      description: 'Manage gateway basics, administrator security, and forwarding settings',
      gatewayLiteDescription: 'Manage gateway basics, administrator security, and forwarding settings'
    },
