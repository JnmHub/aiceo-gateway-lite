...
export const useAppStore = defineStore('app', () => {
  ...
  const siteName = ref<string>('JnmGatewayApi')
  ...
  const isGatewayLiteAdmin = computed(() =>
    cachedPublicSettings.value?.gateway_lite_admin_enabled === true ||
    cachedPublicSettings.value?.ui_surface === 'gateway-lite-admin'
  )
  ...
  function applySettings(config: PublicSettings): void {
    ...
    siteName.value = config.site_name || 'JnmGatewayApi'
  ...
  async function fetchPublicSettings(force = false): Promise<PublicSettings | null> {
    ...
    if (publicSettingsLoaded.value && !force) {
      ...
      return {
        ...
        run_mode: 'standard',
        ui_surface: 'standard',
        gateway_lite_admin_enabled: false,
