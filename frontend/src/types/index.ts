/**
 * Core Type Definitions for JnmGatewayApi Frontend
 */
...
export interface PublicSettings {
  run_mode?: 'standard' | 'simple' | 'gateway-lite'
  ui_surface?: 'standard' | 'gateway-lite-admin' | string
  gateway_lite_admin_enabled?: boolean
