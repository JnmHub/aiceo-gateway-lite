...
const PREFETCH_ADJACENCY: Record<string, string[]> = {
  // gateway-lite（轻量网关）后台只预加载保留的运维页面，避免探测已删除的客户侧/主站后台路由。
  '/admin/dashboard': ['/admin/accounts', '/admin/ops'],
  '/admin/accounts': ['/admin/dashboard', '/admin/groups'],
  '/admin/groups': ['/admin/accounts', '/admin/channels/pricing'],
  '/admin/channels/pricing': ['/admin/model-prices', '/admin/channels/monitor', '/admin/groups'],
  '/admin/model-prices': ['/admin/channels/pricing', '/admin/channels/monitor'],
  '/admin/channels/monitor': ['/admin/channels/pricing', '/admin/model-prices', '/admin/usage'],
  '/admin/usage': ['/admin/ops', '/admin/accounts'],
  '/admin/ops': ['/admin/dashboard', '/admin/usage'],
  '/admin/proxies': ['/admin/settings', '/admin/accounts'],
  '/admin/risk-control': ['/admin/settings', '/admin/ops'],
  '/admin/settings': ['/admin/proxies', '/admin/risk-control']
}
