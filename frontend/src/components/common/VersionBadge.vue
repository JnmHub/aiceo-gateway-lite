<template>
  <div class="relative">
    ...
    <template v-if="isAdmin && !isGatewayLiteAdmin">
      <button
...
const isGatewayLiteAdmin = computed(() => appStore.isGatewayLiteAdmin)
...
async function refreshVersion(force = true) {
  if (!isAdmin.value || isGatewayLiteAdmin.value) return
...
onMounted(() => {
  if (isAdmin.value && !isGatewayLiteAdmin.value) {
